  ...
  rightColumn={
    <div>
     <h2>Base URL</h2>
      ...
      <code>https://valuations-api.dimo.zone/</code>

      <h3>Endpoints</h3>

      <code>GET /v2/vehicles/:tokenId/valuations</code>
      <p></p>
      <code>POST /v2/vehicles/:tokenId/instant-offer</code>
      <p></p>
      <code>GET /v2/vehicles/:tokenId/offers</code>
