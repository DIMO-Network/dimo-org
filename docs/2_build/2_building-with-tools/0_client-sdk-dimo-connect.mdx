  ...
  <Step title="Configure Your URL">
    ...
    :::
      ...
      <Tabs>
        ...
        ![Login With DIMO Configurator](/img/loginwithdimoconfigurator.png)

          <Tabs>
            <TabItem value="URL Sharing" label="URL Sharing">
        ...
        <TabItem value="URL Method" label="Manual URL Params">
          <DimoUrlBuilder />
        </TabItem>
      </Tabs>
  </Step>
