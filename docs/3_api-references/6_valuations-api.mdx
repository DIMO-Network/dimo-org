  ...
  rightColumn={
    ...
    tokenId = 123456
          ...
          },
          {
            label: "cURL",
            language: "shell",
            code: `curl -X GET "https://valuations-api.dimo.zone/v2/vehicles/123456/valuations" \\
  ...
  rightColumn={
    ...
    tokenId = 123456
          ...
          },
          {
            label: "cURL",
            language: "shell",
            code: `curl -X POST "https://valuations-api.dimo.zone/v2/vehicles/123456/instant-offer" \\
  -H "Authorization: Bearer <VEHICLE_JWT>" \\
  ...
  rightColumn={
    ...
    tokenId = 123456
          ...
          },
          {
            label: "cURL",
            language: "shell",
            code: `curl -X GET "https://valuations-api.dimo.zone/v2/vehicles/123456/offers" \\
  -H "Authorization: Bearer <VEHICLE_JWT>"`
          }
        ]}
        defaultLanguage="typescript"
