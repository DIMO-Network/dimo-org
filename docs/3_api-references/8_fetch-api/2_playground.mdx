...
**DID**: The <code>did</code> argument accepts any DID in the DIMO system (e.g. <code>did:erc721:1:0xContractAddress:tokenId</code>). You can resolve it from the Identity API or your token exchange flow.
