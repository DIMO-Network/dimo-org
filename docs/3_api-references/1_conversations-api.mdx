...
# Conversations API <Badge variant="pre-alpha">⚠️ Pre-Alpha</Badge>

:::danger IMPORTANT
Be aware, the Conversations API is in active development and **has not yet been
...
<TwoColumnLayout
  leftColumn={
    <div>
      ...
      The DIMO Conversations API enables developers to create intelligent AI agents that can interact with vehicle data through natural language. These agents can query vehicle information, real-time telemetry, perform web searches to answer questions about vehicles and nearby services, and more.
  ...
  rightColumn={
    <div>
      <BaseUrlBlock url="https://conversations-api.dimo.zone"/>
      <ApiEndpointsBlock
        endpoints={[
          {
            method: 'POST',
