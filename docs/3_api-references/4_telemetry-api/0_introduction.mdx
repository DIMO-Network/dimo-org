---
sidebar_position: 1
description: Query private, real-time signals from DIMO-connected vehicles, including location, speed, fuel, and battery, with the DIMO Telemetry GraphQL API.
---
