...
<Tabs groupId="document-type">
  <TabItem value="dimo.document.vehicle.insurance" label="Insurance">
...
```
  ...
  <TabItem value="dimo.document.vehicle.registration" label="Registration">
...
```
  ...
  <TabItem value="dimo.document.vehicle.title" label="Title">
...
```
  ...
  <TabItem value="dimo.document.vehicle.service.invoice" label="Service invoice">
...
```
  ...
  <TabItem value="dimo.document.vehicle.inspection" label="Inspection">
...
```
  ...
  <TabItem value="dimo.document.vehicle.finance" label="Finance">
...
```
  ...
  <TabItem value="dimo.document.vehicle.regulatory.other" label="Regulatory">
...
```
  ...
  <TabItem value="dimo.document.driver.license" label="Driver license">
